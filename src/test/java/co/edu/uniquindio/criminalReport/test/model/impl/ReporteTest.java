...
public class ReporteTest {
    ...
    public void registrarReporteTest() {
        ...
        Reporte reporte = Reporte.builder()
                .nombre("Reporte de incendio")
                .descripcion("Descripción del reporte de incendio")
                .categoria("Incendios")
        ...
        assertEquals("Reporte de incendio", reporteCreado.getNombre(), "El nombre del reporte no es correcto");
    }
    ...
    public void buscarReporteTest() {
        ...
        assertEquals("Reporte de incendio", reporte.getNombre(), "El nombre del reporte no es correcto");
    }
