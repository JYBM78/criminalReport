...
import co.edu.uniquindio.criminalReport.excepciones.*;
...
import co.edu.uniquindio.criminalReport.seguridad.JWTUtils;
...
public class UsuarioServicioImpl implements UsuarioServicio {
    ...
    public void crear(CrearUsuarioDTO crearUsuarioDTO) throws Exception {
        ...
        EmailDTO emailDTO = new EmailDTO(
                ...
                "Token de Activación - Criminal Report",
                "Bienvenido a Criminal Report.\n\n" +
                        "Para activar tu cuenta, copia el token de autenticación y pégalo en la aplicación:\n\n" +
                        token.token() + "\n\n" +
...
//        ObjectId objectId = new ObjectId(id);
   ...
   public Usuario obtenerPorId(String id) throws RecursoNoEncontradoException {
    ...
    public void reenviarToken(String email) throws Exception {
        ...
        EmailDTO emailDTO = new EmailDTO(
                email,
                "Nuevo Token de Activación - Criminal Report",
                "Nuevo token de activación generado:\n\n" + nuevoToken.token() +
                        "\n\nEste token expirará en 15 minutos."
        );
