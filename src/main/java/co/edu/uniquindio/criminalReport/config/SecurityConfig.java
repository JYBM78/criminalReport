...
import co.edu.uniquindio.criminalReport.seguridad.AutenticacionEntryPoint;
import co.edu.uniquindio.criminalReport.seguridad.JWTFilter;
 ...
 */
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(
                "http://localhost:4200",
                "https://criminalreport.onrender.com" // si tu frontend se despliega en Firebase, agrega sus URLs
